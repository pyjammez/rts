...
- `ultimate_extinction` (`Ultimate Destruction`): original large-scale robot RTS package inspired by metal/energy robot-war games.
- `era_of_kingdoms`: original historical RTS package inspired by food/wood/gold/stone empire games.
- `desert_command`: existing modern desert sample package.
